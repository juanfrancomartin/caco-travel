    ...
    <section className='max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
      <div className='hero-map'/>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
          <Image src="/camp.svg" alt="camp" className='absolute left-[-5px] top-[-30px] w-10 lg:w-[50px]' width={50} height={50}/>
          ...
          <div className='flex w-full gap-3 sm:flex-row flex-col'>
              ...
              <Button variant='btn_white_text' type='button' title='How we work' icon='/play.svg'/>
          </div>
        </div>
