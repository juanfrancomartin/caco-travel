    ...
    <section className='2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        <CampSite
          ...
          subtitle='Lago Puelo, Bariloche'
          peopleJoined='198k people joined'
        />
        <CampSite
          backgroundImage='bg-bg-img-2'
          title='Mountain view'
          subtitle='Lago Escondido, Bariloche'
          peopleJoined='50k people joined'
        />
      </div>
      <div className='flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'>
        <div className='bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl_rounded-5xl xl:px-16 xl_py-20 relative w-full overflow-hidden rounded-3xl'>
          <h2 className='regular-24 md:regular-32 2xl:regular-64 capitalize text-white'>
            <strong>Feeling lost</strong>  must be a thing of the past
